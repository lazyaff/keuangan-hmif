...
$id = $_GET["id"];
$edit = query("SELECT * FROM riwayat join dana on riwayat.id_dana = dana.id_dana where id_hst = $id and riwayat.id_user = $_SESSION[id]")[0];
...
<html>
    <head>
        <title>Perbarui Transaksi | Rustiz</title>
        <meta charset="utf-8" />
                                    ...
                                    <div class="row">
                                        <div class="col-12 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input id="id_hst" name="id_hst" value="<?= $edit["id_hst"] ?>" required type="text" class="form-control" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6 pr-1">
                                            <div class="form-group">
                                                <label>Tanggal</label>
                                                <input id="tgl" name="tgl" value="<?= $edit["tgl"] ?>" required type="date" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-6 pl-1">
                                            <div class="form-group">
                                                <label>Waktu</label>
                                                <input id="wkt" name="wkt" value="<?= $edit["wkt"] ?>" required type="time" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input id="dtl" name="dtl" value="<?= $edit["dtl"] ?>" required type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6 pr-1">
                                            <div class="form-group">
                                                <label>Nominal</label>
                                                <input id="nom" name="nom" value="<?= $edit["nom"] ?>" required type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-6 pl-1">
                                            <div class="form-group">
                                                ...
                                                <select id="ket" name="ket" required type="text" class="form-control">
                                                    <option selected hidden value="<?= $edit["ket"] ?>"><?= $edit["ket"] ?></option>
                                    ...
                                    <div class="row">
                                        <div class="col-12 pr-1">
                                            <div class="form-group">
                                                ...
                                                <select id="id_dana" name="id_dana" value="<?= $edit["id_dana"] ?>" required type="text" class="form-control">
                                                    <option selected hidden value="<?= $edit["id_dana"] ?>"><?= $edit["nama"] ?></option>
