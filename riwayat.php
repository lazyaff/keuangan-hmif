...
<html>
    <head>
        <title>Riwayat Transaksi | Rustiz</title>
        <meta charset="utf-8" />
        ...
        <div class="main" style="margin-top: 20px; margin-bottom: 20px; min-height: 400px;">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-1">
                        <a  class="btn btn-primary" href="tambah-1.php">Tambah</a>
                    </div>
                </div>
                        ...
                        <div class="box">
                            ...
                            <div class="box-body" style="overflow-x:auto;">
                                    ...
                                    <div class="col">
                                        <?php  
                                            ...
                                            if (isset($_POST["filter"]) == false || $_POST["dana"] == 0) {
                                                ...
                                                $key = $_POST["dana"];
                                                $arr =  query("SELECT * from dana where id_dana = $key")[0];
                                                $dn = $arr["nama"];
                                            }
                                        ?>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <?php 
                                                    if ($row["ket"] == "Pemasukan") {
                                                        $nominal = $row["nom"];
                                                        $masuk += $nominal;
                                                        echo "<td style='text-align: right;'> Rp <script> document.write(ribuan(".$nominal.")); </script>,00 </td>";
                                ...
                                <div class="text-center">
                                    <button onclick="exportTableToExcel('riwayat', 'riwayat-transaksi')" class="btn btn-info mt-4"><i class="bi bi-box-arrow-up-right"></i> Ekspor</button>
                                </div>
                            </div>
                        </div>
                    </div>
